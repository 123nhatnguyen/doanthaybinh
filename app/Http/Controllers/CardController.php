...
class CardController extends Controller
{
    ...
    {
        $cart = session()->get('cart', []); // kiểm tra xem trong giỏ hàng có dữ liệu đc gởi đi hay kh nếu kh nó trả về []
        // empty kiểm tra biến có rỗng hoặc chưa được khởi tạo  
        if (empty($cart)) { // nếu $cart trống tức là kh chưa bất kì dữ liệu nào thì trả về kq
